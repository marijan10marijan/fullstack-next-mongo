export default function Home() {
  return (
    <div>
      <h1 className="text-center text-4xl font-semibold text-gray-700 leading-8 my-8">
        Welcome to our next <br />{" "}
        <span className="text-indigo-700 text-5xl font-bold">
          auth application
        </span>{" "}
      </h1>
      <p className="text-center text-gray-600 text-sm leading-6 max-w-[540px] mx-auto mb-12">
      ...
      <div className="grid grid-cols-2 gap-4 max-w-4xl mx-auto px-6">
